...
csv_path = "data/turkcell_reviews.csv"
txt_path = "data/turkcell_reviews.txt"
textgenrnn_weight_path = "data/turkcell_reviews_weight.hdf5"
textgenrnn_output_path = "data/turkcell_reviews_textgenrcnn.txt"
